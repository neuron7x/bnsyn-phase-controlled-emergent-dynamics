...
| GAP-003 | Snapshot source provenance was ambiguous (`local artifact archive` vs workspace checkout). | Audit-trace ambiguity. | no (reframed optional; source recorded explicitly) |
