...
def validate_canonical_bundle(
    ...
    if require_product_surface:
        ...
        if product_summary_path.is_file():
            ...
            summary_metrics = _load_json(root / "summary_metrics.json")
            proof_report = _load_json(root / "proof_report.json")
            ...
            if product_summary.get("proof_verdict") != proof_report.get("verdict"):
            ...
            if seed != summary_metrics.get("seed"):
