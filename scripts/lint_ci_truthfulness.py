...
class LintResult:
    ...
    def to_markdown(self) -> str:
        ...
        lines.append(f"**Warnings:** {len([v for v in self.violations if v.severity == 'warning'])}\n")
        lines.append("\n")
        
        if not self.violations:
            lines.append("✅ **No violations found!** All workflows follow truthfulness guidelines.\n")
            return "\n".join(lines)
