...
class FormalConstantsVerifier:
    ...
    def extract_python_constants(self) -> dict[str, tuple[Any, str]]:
        ...
        if criticality_match:
            constants["GainMin"] = (float(criticality_match.group(1)), "src/bnsyn/config.py:CriticalityParams.gain_min")
            constants["GainMax"] = (float(criticality_match.group(2)), "src/bnsyn/config.py:CriticalityParams.gain_max")
        ...
        if temp_match:
            constants["T0"] = (float(temp_match.group(1)), "src/bnsyn/config.py:TemperatureParams.T0")
            constants["Tmin"] = (float(temp_match.group(2)), "src/bnsyn/config.py:TemperatureParams.Tmin")
            constants["Alpha"] = (float(temp_match.group(3)), "src/bnsyn/config.py:TemperatureParams.alpha")
            constants["Tc"] = (float(temp_match.group(4)), "src/bnsyn/config.py:TemperatureParams.Tc")
            constants["GateTau"] = (float(temp_match.group(5)), "src/bnsyn/config.py:TemperatureParams.gate_tau")
